...
import 'package:CHATS/ui/shared/TF.dart';
...
class _SignUpViewState extends State<SignUpView> {
  ...
  // Widget buildIdentityVerification(double height, SignUpVM model) {
  //   return Column(
  //     crossAxisAlignment: CrossAxisAlignment.center,
  //     children: [
  //       TEXT(
  ...
  //         fontFamily: 'Gilroy-bold',
  //         fontSize: height * 1.5,
  //         edgeInset: EdgeInsets.only(bottom: height * 2),
  //       ),
  ...
  //       //  GestureDetector(child: _buildCard(Icons.upload_outlined, 'Verify NIN/BVN', ' ', height, false), onTap: () async {
